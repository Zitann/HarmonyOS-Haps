...
| [Harmonic](https://github.com/shanyan-wcx/Harmonic) | [Link](https://github.com/shanyan-wcx/Harmonic/releases) | 连接 Navidrome 音乐服务器的鸿蒙原生客户端。 | 06-21 |
| [Audiobookshelf](https://github.com/shanyan-wcx/Audiobookshelf-HarmonyOS) | [Link](https://github.com/shanyan-wcx/Audiobookshelf-HarmonyOS/releases) | 连接 Audiobookshelf 私人有声书服务器的鸿蒙客户端。 | 06-16 |
| [栖云盾](https://github.com/Tlntin/home-cloud-shield) | [Link](https://github.com/Tlntin/home-cloud-shield/releases) | 鸿蒙本地DNS过滤应用，支持AdGuard风格规则拦截广告。 | 06-15 |
| [OHsidian](https://github.com/HanversionOvO/OHSidian) | [Link](https://github.com/HanversionOvO/OHSidian/releases) | 鸿蒙Obsidian笔记移植版，通过Electron兼容层运行。 | 05-30 |
| [影视链](https://github.com/xiaomoHM/videoJX) | [Link](https://github.com/xiaomoHM/videoJX/releases) | 集成多个解析接口，搜索播放全网视频的解析播放器。 | 05-28 |
...
| [ClashBox](https://github.com/xiaobaigroup/hapapp) | [Link](https://github.com/xiaobaigroup/hapapp/releases) | 基于Mihomo内核的鸿蒙代理软件。 | 04-02 |
| [Etohos](https://github.com/collaborative-creation/etohos) | [Link](https://github.com/collaborative-creation/etohos/releases) | 基于Flutter的鸿蒙应用，用于接入EasyTier组网。 | 03-31 |
| [云享社](https://github.com/Edge-Music/Core) | [Link](https://github.com/Edge-Music/Core/releases) | 可连接多个音乐平台与私有源的音乐播放器。 | 03-18 |
| [HOML启动器](https://github.com/xiaobaigroup/HOML) | [Link](https://github.com/xiaobaigroup/HOML/releases) | 首个鸿蒙原生MCJava版HOML启动器 | 02-27 |
| [FinVideo](https://github.com/OHPG/FinVideo) | [Link](https://github.com/OHPG/FinVideo/releases) | 鸿蒙视频播放器，支持Jellyfin/Emby/Plex多服务器。 | 01-17 |
| [Gramony](https://github.com/Gramony/Gramony) | [Link](https://t.me/GramonyApp) | 第三方✈鸿蒙版，下载地址为✈群组 | 01-15 |
| [CanPlayerHap](https://github.com/Merryou6/CanPlayerHap) | [Link](https://github.com/Merryou6/CanPlayerHap/releases) | 鸿蒙NEXT上基于web运行ONS引擎Galgame。 | 2025-11-26 |
| [Minecraft Box](https://github.com/lxdklp/MCB_OHOS) | [Link](https://github.com/lxdklp/MCB_OHOS/releases) | 鸿蒙版Minecraft Java服务器管理工具。 | 2025-10-11 |
| [JellyFin](https://github.com/chashaochang/JellyFin_HarmonyOS) | [Link](https://github.com/chashaochang/JellyFin_HarmonyOS/releases) | 鸿蒙非官方 Jellyfin 客户端，支持播放、字幕与投屏。 | 2025-08-02 |
| [流心视频](https://github.com/Yebingiscn/SweetVideo) | [Link](https://github.com/Yebingiscn/SweetVideo/releases) | 鸿蒙原生视频音乐播放器，支持多格式与外挂字幕。 | 2025-07-31 |
...
| 软件     | 下载链接            | 描述                                                         | 更新                                                 |
| ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [NekoBox4Harmony](https://github.com/xiaoli8571/NekoBox4Harmony) | [Link](https://github.com/xiaoli8571/NekoBox4Harmony/releases) | 基于sing-box内核的鸿蒙VPN客户端，支持多协议与订阅。 | 09-08 |
| [Petrelgram](https://github.com/miramira8295/Petrelgram) | [Link](https://github.com/miramira8295/Petrelgram/releases) | 第三方✈鸿蒙版，基于 TDLib 的 Telegram 客户端，支持多账号与音视频通话。 | 09-07 |
| [开源阅读](https://github.com/mgz0227/legado-Harmony) | [Link](https://github.com/mgz0227/legado-Harmony/releases) | 一款支持自定义书源规则，可抓取任意网页内容进行阅读的开源应用。 | 09-07 |
| [CalculatorX](https://github.com/StarHeartY/CalculatorX) | [Link](https://github.com/StarHeartY/CalculatorX/releases) | 一款支持符号计算、微积分、矩阵、方程求解与函数图像的原生科学计算器。 | 09-07 |
| [PixEz](https://github.com/bgli100/pixez-flutter-ohos) | [Link](https://github.com/bgli100/pixez-flutter-ohos/releases) | 一款支持免代理直连及查看动图的第三方Pixiv flutter客户端 | 09-07 |
| [Kelivo](https://github.com/Chevey339/kelivo) | [Link](https://github.com/Chevey339/kelivo/releases) | 一个Flutter LLM聊天客户端。支持Android、iOS和Harmony Next。 | 09-06 |
...
| [FMphoto](https://github.com/jonas-pi/FMphoto) | [Link](https://github.com/jonas-pi/FMphoto/releases) | 用于在手机上连接飞牛 NAS，使用相册、网页入口及常见图库能力。 | 09-03 |
...
| [刷题宝](https://github.com/xiaomoHM/ShuaTi) | [Link](https://github.com/xiaomoHM/ShuaTi/releases) | 离线刷题应用，支持多套试卷、错题本与随机练习。 | 06-10 |
...
| [KeePassHO](https://github.com/aimilin6688/KeePassHO) | [Link](https://github.com/aimilin6688/KeePassHO/releases) | 兼容KeePass数据库的本地密码管理软件，支持TOTP。 | 03-30 |
| [Harflix播放器](https://github.com/Actrlq/Harflix) | [Link](https://github.com/Actrlq/Harflix/releases) | 一款支持Emby协议的播放器 | 03-15 |
| [niceleep](https://github.com/qinshah/niceleep) | [Link](https://github.com/qinshah/niceleep/releases) | 一个专注于白噪音播放的应用，帮助你放松、专注和入眠。 | 02-11 |
| [soc-search](https://github.com/Amview/soc-search) | [Link](https://github.com/Amview/soc-search/releases) | 查询安兔兔、Geekbench等平台SoC性能跑分排行的工具。 | 2025-09-23 |
| [包名解析](https://github.com/SummerKaze/AppBundleNameForShared) | [Link](https://github.com/SummerKaze/AppBundleNameForShared/releases) | 一款用于从华为应用商城分享链接中提取应用包名的鸿蒙工具。 | 2025-09-14 |
| [KDAuth](https://github.com/kdada/Authenticator) | [Link](https://github.com/kdada/Authenticator/releases) | 支持标准与Steam令牌的双因子认证（2FA）生成工具。 | 2025-08-25 |
| [awesome_blbl](https://github.com/Luo-A-Chen/AwesomeResume) | [Link](https://github.com/Luo-A-Chen/AwesomeResume/releases) | 使用鸿蒙flutter3.22版本开发的第三方B站 | 2025-08-02 |
| [Neon](https://github.com/shokakucarrier/neon-ohos) | [Link](https://github.com/shokakucarrier/neon-ohos/releases) | 鸿蒙版Nextcloud客户端，可连接管理个人云盘。 | 2025-07-01 |
| [LocalSend](https://github.com/Aloereed/localsend-ohos) | [Link](https://github.com/Aloereed/localsend-ohos/releases) | LocalSend鸿蒙版，局域网内安全传输文件与消息。 | 2025-04-15 |
| [影视猫](https://github.com/CatPawApp/CatPawOpen) | [Link](https://github.com/CatPawApp/CatPawOpen/releases) | 类似TVBox的聚合影视播放工具，可配置接口拉取视频源。 | 2025-01-17 |
| [宝可梦图鉴](https://github.com/Luxcis/Pokedex_Next) | [Link](https://github.com/Luxcis/Pokedex_Next/releases) | 一款用于查询宝可梦、招式及特性详细信息的图鉴应用。 | 2025-01-07 |

### 鸿蒙电脑

| 软件     | 下载链接            | 描述                                                         | 更新                                                 |
| ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Servo](https://github.com/servo/servo) | [Link](https://github.com/servo/servo/releases) | Servo 是一个用 Rust 语言编写的浏览器内核的浏览器 | 08-31 |
...
| [Harmonix](https://github.com/hackeris/Harmonix) | [Link](https://github.com/hackeris/Harmonix/releases) | 在鸿蒙PC上运行多种架构Linux程序的终端。 | 2025-08-30 |
