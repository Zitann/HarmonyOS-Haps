...
| [selineRead](https://atomgit.com/liluolinder/selineRead) | [Link](https://atomgit.com/liluolinder/selineRead/releases) | SelineRead 是一个专为鸿蒙系统（HarmonyOS）开发的电子书下载应用。目前主要支持从 zlibrary 下载电子书，为用户提供便捷的电子书获取体验。 | 08-03 |
