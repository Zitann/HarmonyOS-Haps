...
| [包名解析](https://github.com/SummerKaze/AppBundleNameForShared) | [Link](https://github.com/SummerKaze/AppBundleNameForShared/releases) | 一个用于从华为应用商城分享链接中提取应用包名的 HarmonyOS 应用。智能提取应用包名，支持系统分享接入，一键复制到剪贴板。开发者快速获取应用包名的实用工具。 | 06-26    |
